...
class TestAlert(unittest.TestCase):
    ...
    def test_get_jobId(self):
        self.assertEqual(self.alert.get_jobId(), "9183")

    def test_get_clusterId(self):
        self.assertEqual(self.alert.get_clusterId(), 3576457995024682)

    def test_get_clusterIncarnationId(self):
        self.assertEqual(self.alert.get_clusterIncarnationId(), "1674247199596")

    def test_get_protectionGroupId(self):
        self.assertEqual(self.alert.get_protectionGroupId(), "3576457995024682:1674247199596:9183")
